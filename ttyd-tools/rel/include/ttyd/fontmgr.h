...
void FontDrawCodeMtx(gc::mat3x4*, uint16_t code);
...
void FontDrawStringMtx(gc::mat3x4*, const char *text);
void FontDrawStringCenterMtx(gc::mat3x4*, const char *text);
void FontDrawStringShake(float x, float y, const char *text);
void FontDrawMessage(int x, int y, const char *message);
void FontDrawMessageMtx(gc::mat3x4*, const char *message);
